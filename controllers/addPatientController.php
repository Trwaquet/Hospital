...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // 
        ...
        // Création d'un nouvel objet PDO.    
            $patient = new Patient();
        // Set des attribut avec les variable contenant les valeur nettoyer et validé.
            $patient->setLastname($lastname);
            $patient->setFirstname($firstname);
            $patient->setGender($gender);
            $patient->setSocialSecureCode($socialSecureCode);
        ...
        if($isAddedPatient){
            SessionFlash::set('Le patient a bien été ajouté.');
    ...
    include(__DIR__ . '/../views/addPatient.php');
